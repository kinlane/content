...
Currently <a href="http://www.google.com/chrome/intl/en/p/cloudprint.html" target="_blank">Google provides a proxy that works on Windows with Google Chrome</a>. They will be supporting Mac and Linux versions in the near future.<p></p>
