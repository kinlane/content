...
<p class="p2">Ok, so what actually happens in all this "research", "monitoring", and what not? The value from the exhaust...I move things forward using several working models:</p>
